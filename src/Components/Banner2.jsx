        ...
        <div className='bg-white '>
            <div className="  overflow-hidden ">
                <div className=" grid grid-cols-1 py-16 space-y-6 md:grid-cols-2 md:space-y-0  ">
                    ...
                    <div className=" md:pl-16 flex flex-col justify-center items-center md:items-start text-center md:text-left space-y-4 lg:max-w-[500px] ">
                        <motion.p
                        ...
                        <motion.p
                            ...
                            initial="hidden"
                            whileInView={"visible"}
                            className='text-2xl font-bold '>Talented and Qualified Tutors to Serve <br />You for Help
                        </motion.p>
                        <motion.p
                    ...
                    <div className="left flex justify-start items-center text-center  ">
                        <motion.img
                            ...
                            src="https://e-tutor-tcj.netlify.app/assets/banner2-BMWB7nzP.png"
